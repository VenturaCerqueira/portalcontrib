        ...
        <Controller
          ...
          render={({ field, fieldState: { error } }) => (
            <div className="relative">
              <ClipboardDocumentIcon className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 pointer-events-none flex-shrink-0" />
              <select 
                {...field}
                className={`w-full pl-11 px-4 py-3 pr-10 border rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-purple-500 dark:focus:border-purple-400 transition-all ${
                  error 
...
{errors?.tipoLocalAtividade && (
        ...
        <Controller
          ...
          render={({ field, fieldState: { error } }) => (
            <div className="space-y-2">
              <div className="relative">
                <ClipboardDocumentIcon className="absolute left-4 top-4 h-5 w-5 text-gray-400 pointer-events-none flex-shrink-0" />
                <textarea 
                  {...field}
                  autoComplete="off"
                  maxLength={500}
                  rows={4}
                  className={`w-full pl-12 px-4 py-3 pr-10 border rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-purple-500 dark:focus:border-purple-400 resize-vertical transition-all ${
                    error 
      ...
      <div className="lg:col-span-3">
        <label className="block text-sm font-semibold text-gray-700 dark:text-slate-300 mb-3 flex items-center">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${errors?.localNegocio ? 'ring-2 ring-red-200/50 bg-red-50/50 rounded-xl p-4' : ''}`}>
          <label className={`flex items-center p-4 border-2 rounded-xl hover:shadow-md transition-all cursor-pointer group bg-white dark:bg-slate-800/50 ${errors?.localNegocio ? 'border-red-400 bg-red-50/50 dark:bg-red-900/20' : 'border-gray-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-500 hover:shadow-purple-500/20 dark:hover:shadow-purple-500/20'}`}>
            <input 
              ...
              className="mr-2 text-purple-600 dark:text-purple-400 w-5 h-5"
              autoComplete="off"
            />
            <svg className="w-5 h-5 mr-3 text-purple-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m-1 4h1m-1-4H3m13 0h2" />
            </svg>
          ...
          <label className={`flex items-center p-4 border-2 rounded-xl hover:shadow-md transition-all cursor-pointer group bg-white dark:bg-slate-800/50 ${errors?.localNegocio ? 'border-red-400 bg-red-50/50 dark:bg-red-900/20' : 'border-gray-200 hover:border-purple-300 hover:shadow-md'}`}>
            <input 
              ...
              className="mr-2 text-purple-600 w-5 h-5"
              autoComplete="off"
            />
            <svg className="w-5 h-5 mr-3 text-purple-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${errors?.jaTrabalhaPrefeituraEventos ? 'ring-2 ring-red-200/50 bg-red-50/50 rounded-xl p-4' : ''}`}>
          <label className={`flex items-center p-4 border-2 rounded-xl hover:shadow-md transition-all cursor-pointer group bg-white dark:bg-slate-800/50 ${errors?.jaTrabalhaPrefeituraEventos ? 'border-red-400 bg-red-50/50 dark:bg-red-900/20' : 'border-gray-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-500 hover:shadow-md dark:hover:shadow-purple-500/20'}`}>
            <input 
              ...
              autoComplete="off"
            />
            <svg className="w-5 h-5 mr-3 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
